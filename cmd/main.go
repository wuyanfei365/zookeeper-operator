...
import (
	...
	"zookeeper-operator/pkg/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "1e51e730.github.com",
	})
	if err != nil {
	...
	if err = (&controllers.ZookeeperClusterReconciler{
		...
		Recorder: mgr.GetEventRecorderFor("ZookeeperCluster-controller"),
		ZkClient: new(clients.DefaultZookeeperClient),
